...
function HomeView() {
  ...
  return (
      ...
      :
      'h-[120vh] w-screen duration-500 md:bg-cover mt-24 sm:-mt-20 bg-horizontal md:bg-[url("../components/images/main_bg4.jpeg")] bg-[url("../components/images/main_bg4.jpeg")]' 
      }>
        <div className={searchShow ? 
