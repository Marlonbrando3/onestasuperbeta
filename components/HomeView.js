...
function HomeView() {
  ...
  return (
      ...
      :
      'h-screen w-screen mt-24 duration-500 md:bg-cover sm:-mt-20 bg-horizontal md:bg-[url("../components/images/main_bg4.jpeg")] bg-[url("../components/images/main_bg4.jpeg")]' 
      }>
        <div className={searchShow ? 
