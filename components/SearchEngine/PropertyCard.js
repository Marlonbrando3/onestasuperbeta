      ...
      <div className='flex flex-col w-1/2 bg-white '>
          ...
          <div className='flex items-center w-full lg:h-14 h-12 bg-gray-900 '>
            ...
            <div className='flex flex-col items-center justify-center w-3/12 h-full border-2 bg-white p-1'>
                ...
                <div className='flex flex-col items-center lg:flex-row justify-center'>
                  <PoolOutlinedIcon className="w-5 lg:w-8 h-6"/>
            ...
            <div className='flex flex-col items-center justify-center w-3/12 h-full border-2 bg-white p-1'>
              ...
              <div className='flex items-center flex-col lg:flex-row justify-center'>
                <OtherHousesIcon className="w-5 lg:w-8 h-6"  />
          ...
          <div className='bg-red-500 lg:h-52 h-32 flex items-center justify-between text-darkblue text-2xl px-3 font-semibold'>
            <span className="ml-1 text-white md:text-3xl text-2xl ">{PriceOne} {PriceTwo} €</span>
            <span 
