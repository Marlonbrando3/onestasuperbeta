  ...
  return (
    <div className='flex items-center w-full h-12'>
        <span className='w-full'>
            <select value={choosedCountry.country} onChange={handleChangeCountry} id="Country" className="text-sm py-2 px-2 w-full border border-gray-400 rounded-md outline-none" placeholder="Wybierz z listy">
