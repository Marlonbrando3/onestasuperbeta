...
export default function MainTheme({searchShow}) {
  ...
  return (
    <div className={searchShow && 'hidden transition duration-500'}>
        <div className='flex flex-col transition absolute text-white top-64 left-10 h-66 lg:w-1/2 w-full border-yellow-500 lg:border-l-8 border-l-4 z-96 lg:pl-10 pl-1'>
